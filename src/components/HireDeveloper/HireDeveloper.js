...
<Grid xs={12} sm={12} item><h3 style={{textAlign:'center'}} className='figure_plans'>Choose How <span style={{color:'#086AD8'}}>YOU WANT</span> to Integrate</h3></Grid>
<Grid xs={12} sm={12} item><h1 className='we_run' style={{textAlign:'center'}} >  The <span style={{color:'#086AD8'}}>Darwin</span> Advantages</h1></Grid>  
     </Grid>
        </div>
        <div className='hiredeveloper_sub2'>
          ...
          <Grid align='center' justify='center' item xs={12} sm={6} md={3} lg={3}>
              <div className='hire_developer_project_based'>
                ...
                <div className='hire_developer_project_based_text'>Optimal</div>
            </div>
            ...
            <Grid align='center' justify='center' item  xs={12} sm={6} md={3} lg={3}>
              <div className='hire_developer_project_based'>
                ...
                <div className='hire_developer_project_based_text'>Scalable </div>
            </div>
            ...
            <Grid align='center' justify='center' item  xs={12} sm={6} md={3} lg={3}>
              <div className='hire_developer_project_based'>
                ...
                <div className='hire_developer_project_based_text'>Secure</div>
            </div>
            ...
            <Grid align='center' justify='center' item  xs={12} sm={6} md={3} lg={3}>
              <div className='hire_developer_project_based'>
                ...
                <div className='hire_developer_project_based_text'>Simplified </div>
            </div>
